...
class AllProducts extends Form {
    ...
    handleLagirl = async () => {
        await axios.get(`${process.env.REACT_APP_API_URL}/api/productCrawler/v1/lagirl/`);
        this.handleAllProducts();
    };
        ...
        return (
            <div>
                ...
                <ButtonGroup style={{ flex: "100% !important", width: "100%", textAlign: "center" }} color="secondary" size="large" aria-label="large outlined secondary button group" >
                    ...
                    <Button onClick={this.handleLagirl} style={{ width: "100%" }} variant="outlined" > Lagirl</Button>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-sm-12 row">
                                <div class="col-sm-3" 
                                    // style={{ flex: "100% !important", width: "100%", textAlign: "center" }} 
                                    color="secondary" size="large" aria-label="large outlined secondary button group">
                                ...
                                <div className="cart-table">
                                    ...
                                    <div className="cart-table-warp">
                                        <MyTable
                                            ...
                                            columns={[
                                                'title', 'price', 'category', 'brand', 'action', 'action',
                                            ]}
                                        />
